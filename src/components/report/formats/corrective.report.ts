    ...
    generate(workbook: Workbook, cases: any[]): Worksheet {
        ...
        cases.forEach(c => {
            worksheet.addRow({
                ...
                typeService: c.serviceData?.typeService || 'N/A',
                technicianName: c.assignedTechnician?.name || 'N/A',
                technicianPosition: c.assignedTechnician?.position || 'N/A',
                levelService: c.serviceData?.levelService || 'N/A',
                priority: c.serviceData?.priority || 'N/A',
                category: c.serviceData?.category || 'N/A',
                effectivenessRating: ratingMap[c.effectivenessRating] || 'N/A',
                satisfactionRating: ratingMap[c.satisfactionRating] || 'N/A',
                status: c.status || 'N/A',
                levelEscalation: c.escalation?.level || 'N/A',
                technicianEscalationName: c.escalation?.technician?.name || 'N/A',
